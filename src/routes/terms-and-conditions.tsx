    ...
    <div class={styles.layout}>
      ...
      <ul>
        ...
        <Text As="li" FontSize="header">
          ...
          in this Agreement) refers to Chatplats LLC.
        </Text>
        <Text As="li" FontSize="header">
        ...
        <Text As="li" FontSize="header">
          "Terms and Conditions": (also referred as "Terms" or "Terms of Use")
        ...
        <Text As="li" FontSize="header">
          "Website": refers to Chatplats, accessible from https://chatplats.com
        </Text>
        <Text As="li" FontSize="header">
      ...
      <Text As="p" FontSize="header">
        ...
        the Service if You post such objectionable Content.
      </Text>
      <Text As="p" FontSize="header">
      ...
      <Text As="p" FontSize="header">
        ...
        copyright agent via email (copyright@chatplats.com) and include in Your
      ...
      <Text As="p" FontSize="header">
        You can contact our copyright agent via email (copyright@chatplats.com).
      ...
      <ul>
        <Text As="li" FontSize="header">
          By sending us an email: contact@chatplats.com
        </Text>
      </ul>
    </div>
  );
